...
### 사용자 승인 대기 — 승인 시 즉시 구현 가능

- [ ] **F-8(B) — 채널 [50]·[51] `NOT_AVAILABLE_ON_THIS_BRANCH` 표기** (권고 확정안).
...
- [ ] **F-9 — ConstOut 채널 번호 `[51]` → `[54]` 단독 재배정** (양 PC 합의 요건 소멸).
  [55]는 486차 선점 · settings.py:3951 주석이 [54]를 예약함. 키 문자열 불변.
  F-8(B)와 **한 커밋** 권장.
