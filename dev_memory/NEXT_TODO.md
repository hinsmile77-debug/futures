...
- [ ] **F-8 캠페인 채널 [50]/[51] 생산부 결손 해소** — (A)/(B)/(C) 택일, 권고 (C).
  검증 채널 O-21(08-28 금 EOD).
- [ ] **F-9 캠페인 채널 번호 `[51]` 중복 해소** — 주간회의 합의 후
  (권고: 선착 우선 — ConstOut → `[54]`).
...
- [ ] **F-8 (채널 [50]·[51] 생산부 결손) — (A)/(B)/(C) 택일. 권고 (C).** (0821 등재, 이월)
- [ ] **F-9 (채널 번호 `[51]` 중복) — 번호 재배정.** 권고: 나중에 붙인 ConstOut을 **`[54]`**로.
  ⚠ **양 PC 동시 적용 필요.** (0821 등재, 이월)
