...
**4-2 후속 (0804 점검 제안, 미구현)** — 캠페인 채널 3건 등록:
`phantom_stop_edge`(11건/2일) · `grade_x_promotion`(6건/2일) ·
`hurst_meanrevert_drag`(54건/10일, **일자단위 p=0.4531로 미유의**).
셋 다 `min_days` 미달이라 지금 조치하면 313차 위반 — **등록해 표본만 쌓을 것**.
