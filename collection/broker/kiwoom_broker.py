...
from collection.kiwoom import KiwoomAPI, LatencySync, RealtimeData
...
class KiwoomBroker(BrokerAPI):
    ...
    def send_market_order(
        ...
        *,
        ...
        return self._api.send_order_fo(
            rqname=rqname,
            screen_no=screen_no,
            acc_no=account_no,
            code=code,
