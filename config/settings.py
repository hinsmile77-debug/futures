...
# 2026-05-16 재보정: KOSPI200 선물 1200pt 대 고변동성 장세 반영
# 5월 초 일중 고저폭 ~96pt 기준 σ_1min≈1.47pt → 각 threshold ≈ 0.4~0.5σ (FLAT 비율 29~37% 목표)
# 이전값: 1m=0.0002, 3m=0.0003, 5m=0.0004, 10m=0.0006, 15m=0.0008, 30m=0.0012
HORIZON_THRESHOLDS = {
    "1m":  0.0005,   # 0.05% → 1200pt 기준 0.60pt (12틱)
    "3m":  0.0008,   # 0.08% → 1200pt 기준 0.96pt (19틱)
    "5m":  0.0011,   # 0.11% → 1200pt 기준 1.32pt (26틱)
    "10m": 0.0016,   # 0.16% → 1200pt 기준 1.92pt (38틱)
    "15m": 0.0022,   # 0.22% → 1200pt 기준 2.64pt (53틱)
...
ENSEMBLE_WEIGHTS_CORR_ADJ = {
    "1m": 0.20, "3m": 0.16, "5m": 0.14,
    "10m": 0.14, "15m": 0.16, "30m": 0.20,
}
