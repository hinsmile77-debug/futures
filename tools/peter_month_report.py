...
HEAD = {
 ...
 '2026-09': [
  ...
  "> 9/01~9/09 약 0.00 → 9/10 -1.70 → 9/11 -4.50 → 9/17 -4.53 으로 계단처럼 내려간다.",
  "> 오프셋은 매일 그날 캔들로 다시 재므로 롤은 저절로 교정된다 — 손으로 고칠 것이 없다.\n",
  "\n## 월간 요약 — 본인 공개 기준\n",
  "| 항목 | 값 |\n|---|---|",
  "| 사료가 있는 날 | 13일 (9/01~9/17 영업일 전부) |",
  "| 실시간 중계 매매일 | 5일 (9/11 · 9/14 · 9/15 · 9/16 · 9/17) |",
  "| 본인이 손익을 밝힌 날 | 3일 — 9/11 +9P(2차만) · 9/16 +10P · 9/17 -7P |",
  "| 손익 미공개 | 9/14 · 9/15 (거래는 중계했으나 합계를 말하지 않았다) |",
