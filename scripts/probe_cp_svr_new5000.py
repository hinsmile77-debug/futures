...
def _ensure_runtime() -> None:
    ...
    if struct.calcsize("P") != 4:
        raise RuntimeError("CpSvrNew5000 COM requires 32-bit Python")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Probe Cybos CpSvrNew5000 payload")
    parser.add_argument("--code", required=True, help="Option code to query, e.g. B0165A01")
    parser.add_argument(
        "--progid",
        default="CpSysDib.CpSvrNew5000",
        help="COM ProgID to dispatch (default: CpSysDib.CpSvrNew5000)",
    )
    ...
    try:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Common cause: invalid ProgID. Known candidate: CpSysDib.CpSvrNew5000"
            ) from exc
