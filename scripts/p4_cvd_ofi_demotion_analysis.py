...
배경: 398차 정기점검 딥다이브에서 오늘(2026-07-28) 유일 손실 거래(14:00, -183,441원)가
`[P4] CVD+OFI 동시 역방향 → 등급 A→C 강등` 신호였음을 확인했고, 제안 2(가설 수준)로
"P4 강등 신호는 완전차단 대신 사이징 축소를 검토하되, 먼저 [P4] 발동분만 골라
승률/손익을 집계한 뒤 판단할 것"을 등록했다.
