...
def _ensure_runtime() -> None:
    ...
    if struct.calcsize("P") != 4:
        raise RuntimeError("FutureOptionStatPB COM requires 32-bit Python")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Probe Cybos FutureOptionStatPB payload")
    parser.add_argument("--code", help="Optional input code, e.g. B0165A01 or nearest future code")
    parser.add_argument(
        "--progid",
        default="Dscbo1.FutureOptionStatPB",
        help="COM ProgID to dispatch (default: Dscbo1.FutureOptionStatPB)",
    )
    ...
    try:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Common cause: invalid ProgID. Known candidate: Dscbo1.FutureOptionStatPB"
            ) from exc
