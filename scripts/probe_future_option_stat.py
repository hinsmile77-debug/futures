...
def _ensure_runtime() -> None:
    ...
    if struct.calcsize("P") != 4:
        raise RuntimeError("FutureOptionStat COM requires 32-bit Python")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Probe Cybos FutureOptionStat payload")
    parser.add_argument("--code", help="Optional input code, e.g. A355 or nearest future code")
    parser.add_argument(
        "--progid",
        default="Dscbo1.FutureOptionStat",
        help="COM ProgID to dispatch (default: Dscbo1.FutureOptionStat)",
    )
    ...
    try:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Common cause: invalid ProgID. Known candidate: Dscbo1.FutureOptionStat"
            ) from exc
