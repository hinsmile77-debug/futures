...
def _ensure_runtime() -> None:
    ...
    if struct.calcsize("P") != 4:
        raise RuntimeError("CpSvrNew7221 COM requires 32-bit Python")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Probe Cybos CpSvrNew7221 payload")
    parser.add_argument("--code", help="Optional input code, e.g. B0165A01 or nearest future code")
    parser.add_argument(
        "--progid",
        default="CpSysDib.CpSvrNew7221",
        help="COM ProgID to dispatch (default: CpSysDib.CpSvrNew7221)",
    )
    ...
    try:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Common cause: invalid ProgID. Known candidate: CpSysDib.CpSvrNew7221"
            ) from exc
