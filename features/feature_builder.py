...
class FeatureBuilder:
    ...
    def build(
        ...
        # [MW0602 502차 후속 U-1 체리픽] `trend_efficiency_ready` 동반 — hurst_ready
        # 관례와 동일. 표본 부족 폴백값 0.5가 진입 게이트 후보 임계 0.32보다 **커서**
        # 폴백이 게이트를 통과하는 결함의 선치다(계측 4원칙 ④). 소비자는 ready=False를
        # 별도 취급할 것. 상세: features/technical/trend_efficiency.py docstring.
        try:
