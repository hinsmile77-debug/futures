...
|---|---|---|---|---|
| `launcher_{DATE}_084001_2415.log` | 1 | `logs/Mireuk_batch/launcher_20260818_084001_2415.log` | 1.4MB | 08-18 13:43 |
...
| `{DATE}_DATA.log` | 1 | `logs/20260818_DATA.log` | 250.6KB | 08-18 13:43 |
| `{DATE}_DEBUG.log` | 1 | `logs/20260818_DEBUG.log` | 180.2KB | 08-18 13:43 |
| `{DATE}_HEALTH.log` | 1 | `logs/20260818_HEALTH.log` | 4.4KB | 08-18 13:43 |
| `{DATE}_HOGA.log` | 1 | `logs/20260818_HOGA.log` | 41.7MB | 08-18 13:44 |
| `{DATE}_LEARNING.log` | 1 | `logs/20260818_LEARNING.log` | 226.2KB | 08-18 13:43 |
| `{DATE}_MICRO.log` | 1 | `logs/20260818_MICRO.log` | 829.3KB | 08-18 13:44 |
| `{DATE}_PROBE.log` | 1 | `logs/20260818_PROBE.log` | 73.6KB | 08-18 13:43 |
| `{DATE}_SIGNAL.log` | 1 | `logs/20260818_SIGNAL.log` | 527.9KB | 08-18 13:43 |
| `{DATE}_SYSTEM.log` | 1 | `logs/20260818_SYSTEM.log` | 682.6KB | 08-18 13:44 |
| `{DATE}_TRADE.log` | 1 | `logs/20260818_TRADE.log` | 26.3KB | 08-18 13:43 |
| `{DATE}_WARN.log` | 1 | `logs/20260818_WARN.log` | 103.7KB | 08-18 13:41 |

## 2. 코드·커밋 상태

- HEAD `7dc14bc` · 브랜치 `v9-dev` · 미커밋 454건
```
...
_본문 미열람(설정): `20260818_HOGA.log` 41.7MB — 존재와 크기만 증거로 본다_
...
### `logs/20260818_TRADE.log` — 26.3KB · 190행 · 최종 13:43:01

- 형식 평문 · 시각 인식 190행 · WARNING=1, INFO=189
...
2026-08-18 09:35:58 [INFO] TRADE: [Sizer] 미니선물 실효잔고=50,000,000(실제잔고=50,053,027) 기본리스크=1,500,000 신뢰도배수=0.6 레짐배수=0.8 안전배수=1.00(정상) → 3계약 (최소=1)
  …
2026-08-18 13:23:59 [INFO] TRADE: [Sizer] 미니선물 실효잔고=50,000,000(실제잔고=50,585,496) 기본리스크=1,500,000 신뢰도배수=0.6 레짐배수=0.8 안전배수=1.00(정상) → 3계약 (최소=1)
2026-08-18 13:25:59 [INFO] TRADE: [Sizer] 미니선물 실효잔고=50,000,000(실제잔고=50,585,496) 기본리스크=1,500,000 신뢰도배수=0.6 레짐배수=0.8 안전배수=1.00(정상) → 3계약 (최소=1)
2026-08-18 13:33:01 [INFO] TRADE: [Sizer] 미니선물 실효잔고=50,000,000(실제잔고=50,585,496) 기본리스크=1,500,000 신뢰도배수=0.6 레짐배수=0.8 안전배수=1.00(정상) → 3계약 (최소=1)
...
**컴포넌트 상위 15** — `Chejan`×47, `Sizer`×40, `Position`×29, `주문요청`×21, `JointGateBlock 차단`×10, `진입체크`×7, `체결진입`×7, `청산 완료`×7, `TickTP1`×6, `TP1 부분청산`×6, `체결진입보정`×5, `TickStop-S0C`×2, `ProfitGuard`×1, `손절1차 조기축소`×1, `ProfitGuard-L1`×1
...
### `logs/20260818_SYSTEM.log` — 682.6KB · 4732행 · 최종 13:44:04

- 형식 평문 · 시각 인식 4725행 · INFO=4725, PLAIN=7
...
2026-08-18 08:41:00 [INFO] SYSTEM: [FeatureBuilder] 기동 시 전일(2026-08-14) 종가 버퍼 로드: 384봉
  …
2026-08-18 13:43:59 [INFO] SYSTEM: [BAR-CLOSE][CYBOS] ts=13:43 O=1091.20 H=1091.30 L=1090.00 C=1091.30 V=200
2026-08-18 13:43:59 [INFO] SYSTEM: [CVD-ANCHOR] ts=13:43 vol=200 | live_buy=118 shadow_buy=90 anchor_buy=90 | resid(anchor)=0 resid(shadow)=0 unknown_ticks=0 resets=0
2026-08-18 13:43:59 [INFO] SYSTEM: [S6Detail] ensemble=3ms checklist_pre=9ms meta_gate=3ms gates=0ms imp=0ms shap=3ms corr=5ms dash_ui=0ms tail=14ms
2026-08-18 13:43:59 [INFO] SYSTEM: [PipePerf][DBG] total=284ms | S0=2ms S1=18ms S2=6ms S3=0ms S4=62ms S5=150ms S6=38ms S7=5ms S8=2ms
2026-08-18 13:44:04 [INFO] SYSTEM: [CybosRT-TICK] #109800 code=A0569 raw_time=134405 parsed=13:44:05 price=1090.72 vol=1 bid1=1090.62 ask1=1090.74 flag=50 side=SELL anchor=0/1
```
...
**컴포넌트 상위 15** — `CybosInvestorRaw`×1130, `CybosRT-TICK`×1103, `CybosRT-ROLLOVER`×299, `BAR-CLOSE`×299, `CVD-ANCHOR`×299, `TickUI`×297, `S6Detail`×284, `PipePerf`×284, `CybosEvent`×94, `BalanceUI`×76, `System`×74, `MicroRegime`×69, `CybosDailyPnl`×64, `BalanceRefresh`×56, `OptionChain`×38

### `logs/20260818_SIGNAL.log` — 527.9KB · 4555행 · 최종 13:43:59

- 형식 평문 · 시각 인식 4555행 · WARNING=1907, INFO=2648
...
2026-08-18 08:40:43 [INFO] SIGNAL: [DynMC] 기동 복원: CLOSE_VOLATILE  0.620 → 0.417
  …
2026-08-18 13:43:59 [WARNING] SIGNAL: [WeightCollapse] 실질 가중합 0 (1연속) — 활성기대=['10m', '15m', '3m', '5m'] 중 미배포=['10m', '15m', '3m', '5m'] → flat_score=1.0 안전망 발동 (active_horizons=None)
2026-08-18 13:43:59 [INFO] SIGNAL: [Ensemble] dir=+0 conf=84.4% grade=X regime=NEUTRAL [WeightCollapse]
2026-08-18 13:43:59 [INFO] SIGNAL: 앙상블: dir=+0 conf=84.4% grade=X micro=추세장
2026-08-18 13:43:59 [INFO] SIGNAL: [ZeroDiag] 진입X 원인: FLAT수렴
2026-08-18 13:43:59 [INFO] SIGNAL: [ProfitGuard] 진입 차단 [L1-Trail] 피크 +927,000원 대비 20% 하락 (현재 +685,000원 < 보호선 +741,600원)
```
...
| `Checklist` | 97 | 09:05:58 | 13:40:59 | 신뢰도 미달 34.9% < 39.2% → 강제 X등급 |
| `ScalerMonitor` | 88 | 09:00:58 | 12:30:58 | ts=09:00 horizon=1m age=2m max_z=+6.42(ret_15m) extreme=2 |
| `WeightCollapse` | 60 | 09:07:59 | 13:43:59 | 실질 가중합 0 (1연속) — 활성기대=['3m'] 중 미배포=['3m'] → flat_score=1.0 안전망 발동 (active_horizons=['3m']) |
...
**컴포넌트 상위 15** — `ScalerFloor`×1362, `SIGNAL`×568, `MetaGate`×378, `Ensemble`×293, `FQAdj`×282, `ZeroDiag`×232, `ScalerRefresh`×222, `Checklist`×186, `Model`×168, `ATR-Horizon`×141, `ScalerMonitor`×88, `ToxicityGate`×84, `차단`×81, `ProfitGuard`×75, `MicroRegime`×69

### `logs/20260818_LEARNING.log` — 226.2KB · 2157행 · 최종 13:43:59

- 형식 평문 · 시각 인식 2157행 · WARNING=154, INFO=2003
...
2026-08-18 08:41:05 [INFO] LEARNING: [Calibration] 축퇴 해소 — span=0.00064 auc=0.556 out_max=0.2004 (n=90) → 보정 재적용
  …
2026-08-18 13:43:01 [INFO] LEARNING: [SGD] 3건 학습 | SGD비중=30% 50분정확도=7.1%
2026-08-18 13:43:59 [INFO] LEARNING: [sigma] sigma_at_t=0.1239% buf_n=20 nonzero=20 prev_p=1091.14 cur_p=1091.30
2026-08-18 13:43:59 [INFO] LEARNING: ✓ 1m 예측 적중 (conf=39.1% FL)
2026-08-18 13:43:59 [INFO] LEARNING: ✗ 30m 예측 실패 (conf=38.4% 예측=UP 실제=FL)
2026-08-18 13:43:59 [INFO] LEARNING: [SGD] 2건 학습 | SGD비중=30% 50분정확도=7.1%
```
...
**컴포넌트 상위 15** — `LEARNING`×922, `Calibration`×302, `SGD`×283, `sigma`×271, `Bias`×101, `Bias⚠`×90, `MetaConf`×61, `ScalerWarmup`×42, `OnlineLearner`×36, `GBM-64`×10, `GBM`×10, `SHAP`×9, `BiasReset`×9, `RF`×6, `ExtremityCorrector`×2
...
**체크리스트 미통과 항목 누적** — `2_confidence`×30, `3_vwap`×9, `6_foreign`×8, `7_prev_bar`×7, `4_cvd`×6, `5_ofi`×3, `10_chase`×2
...
- 이 로그 생존구간: 08:40 ~ 13:44

**매분 루프 커버리지 09:00~15:10: 285/371분 (76.8%)**
...
6. `logs/20260818_SYSTEM.log`: 매분 루프 커버리지 285/371분 (76.8%) — 루프가 빠진 구간이 있다
7. `logs/20260818_SYSTEM.log`: 13:45~15:10 **연속 86분 매분 루프 기록 없음**
