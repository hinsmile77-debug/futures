...
- 생성 2026-09-17 12:28:38 KST · PC **MW0601** (`DeskTop-MW0601`)
...
| `heartbeat_MW0601_{DATE}.json` | 1 | `data/heartbeat_MW0601_20260917.json` | 244B | 09-17 12:28 |
...
| `launcher_{DATE}_061535_17120.log` | 1 | `logs/Mireuk_batch/launcher_20260917_061535_17120.log` | 5.0MB | 09-17 12:28 |
...
| `{DATE}_DATA.log` | 1 | `logs/20260917_DATA.log` | 182.3KB | 09-17 12:28 |
| `{DATE}_DEBUG.log` | 1 | `logs/20260917_DEBUG.log` | 132.8KB | 09-17 12:28 |
| `{DATE}_HEALTH.log` | 1 | `logs/20260917_HEALTH.log` | 1.6KB | 09-17 11:58 |
| `{DATE}_HOGA.log` | 1 | `logs/20260917_HOGA.log` | 30.1MB | 09-17 12:28 |
| `{DATE}_LEARNING.log` | 1 | `logs/20260917_LEARNING.log` | 416.3KB | 09-17 12:28 |
| `{DATE}_MICRO.log` | 1 | `logs/20260917_MICRO.log` | 572.2KB | 09-17 12:28 |
| `{DATE}_PROBE.log` | 1 | `logs/20260917_PROBE.log` | 58.1KB | 09-17 12:27 |
| `{DATE}_REGULAR_COLLECT.log` | 1 | `logs/20260917_REGULAR_COLLECT.log` | 21.6KB | 09-17 07:10 |
| `{DATE}_SIGNAL.log` | 1 | `logs/20260917_SIGNAL.log` | 350.9KB | 09-17 12:28 |
| `{DATE}_SYSTEM.log` | 1 | `logs/20260917_SYSTEM.log` | 467.7KB | 09-17 12:28 |
| `{DATE}_TRADE.log` | 1 | `logs/20260917_TRADE.log` | 2.0KB | 09-17 11:14 |
| `{DATE}_WARN.log` | 1 | `logs/20260917_WARN.log` | 4.2MB | 09-17 12:28 |

## 2. 코드·커밋 상태

- HEAD `2cd4acb` · 브랜치 `v9-dev` · 미커밋 68건 · 실질 변경 6건 · 코드(.py) 3건 · EOL 파생 0건 (추적변경 6 · 미추적 62 · 삭제 0 · core.autocrlf=true) · 🔴 **인덱스락 잔존** 0바이트 · 0.0시간 · git 프로세스 0개 (판정 보류 — 3중 조건 미충족)
  - 실질 변경 파일: `dev_memory/DECISION_LOG.md`, `dev_memory/NEXT_TODO.md`, `docs/정기점검/수익률향상_누적대장.md`, `features/levels/levels_store.py`, `features/levels/premarket_levels.py`, `scripts/cybos_autologin.py`
  - 락 자가점검: 이 수집 실행은 락을 만들지 않았다
```
M dev_memory/DECISION_LOG.md
 M dev_memory/NEXT_TODO.md
 M docs/정기점검/수익률향상_누적대장.md
...
?? docs/stack_gate_shadow_HOOK.md
?? "docs/미륵이고도화3/Golden power/GP개인수급채널_재검정_MW0601-20260911.md"
?? "docs/미륵이고도화3/Golden power/GP기준진입청산검정법제안.md"
?? "docs/미륵이고도화3/Golden power/GP진입조건_검정A_딥다이브_MW0601-20260910.md"
?? "docs/미륵이고도화3/Golden power/GP휩소판별_딥다이브_MW0601-20260911.md"
?? "docs/미륵이고도화3/Golden power/analysis/testA/"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/divpanel_full.pkl"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/extract_ws.py"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/fwd.npy"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/out1_filters.txt"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/out2_confirm.txt"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/out3_decomp.txt"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/out4_daystate.txt"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/out5_retail_contrarian.txt"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/out6_retail_contrarian_full.txt"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/out7_confirm.txt"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/out8_put_adversarial.txt"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/panel.pkl"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/parse_logs.py"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/parse_logs2.py"
?? "docs/미륵이고도화3/Golden power/analysis/whipsaw/signals.pkl"
… 외 28건
```
...
_본문 미열람(설정): `20260917_HOGA.log` 30.1MB — 존재와 크기만 증거로 본다_
...
### `logs/20260917_WARN.log` — 4.2MB · 20227행 · 최종 12:28:38

- 형식 평문 · 시각 인식 20227행 · CRITICAL=1, ERROR=1, WARNING=20225
...
2026-09-17 05:39:48 [WARNING] SYSTEM: [출처축] 미분류 entry_source ['PHANTOM_STATE_ARTIFACT'] — 「자동」이 아니라 「미측정」으로 집계한다. 시스템 거래라면 PROFIT_GUARD_SYSTEM_SOURCES 에, 사람·외부라면 _MANUAL_SOURCES 에 등록할 것
  …
2026-09-17 12:28:38 [WARNING] SYSTEM: [ChartDBG] paintEvent slow 172.0ms | size=1886x888 candles=221 grid=94.0 spans=0.0 candles=0.0 dir=15.0 regime=0.0 markers=63.0 axes=0.0 cross=0.0 | slow_cnt=19280 total_cnt=21177
2026-09-17 12:28:38 [WARNING] SYSTEM: [ChartDBG] paintEvent slow 141.0ms | size=1886x888 candles=221 grid=78.0 spans=0.0 candles=0.0 dir=0.0 regime=16.0 markers=47.0 axes=0.0 cross=0.0 | slow_cnt=19281 total_cnt=21178
2026-09-17 12:28:38 [WARNING] SYSTEM: [ChartDBG] paintEvent slow 187.0ms | size=1886x888 candles=221 grid=78.0 spans=0.0 candles=15.0 dir=0.0 regime=0.0 markers=94.0 axes=0.0 cross=0.0 | slow_cnt=19282 total_cnt=21179
2026-09-17 12:28:39 [WARNING] SYSTEM: [ChartDBG] paintEvent slow 172.0ms | size=1886x888 candles=221 grid=93.0 spans=0.0 candles=0.0 dir=0.0 regime=0.0 markers=79.0 axes=0.0 cross=0.0 | slow_cnt=19283 total_cnt=21180
2026-09-17 12:28:39 [WARNING] SYSTEM: [ChartDBG] paintEvent slow 187.0ms | size=1886x888 candles=221 grid=94.0 spans=0.0 candles=0.0 dir=0.0 regime=15.0 markers=78.0 axes=0.0 cross=0.0 | slow_cnt=19284 total_cnt=21181
```
...
| tag | 건수 | 최초 | 최종 | 대표 |
|---|---|---|---|---|
| `ChartDBG` | 20087 | 05:40:02 | 12:28:39 | paintEvent slow 125.0ms | size=1886x916 candles=411 grid=62.0 spans=0.0 candles=16.0 dir=0.0 regime=0.0 markers=31.0 axes=16.0 cross=0.0 | slow_cnt=1 total_cnt=1 |
...
**채널** — `SYSTEM`×20222, `HEALTH`×5

**컴포넌트 상위 15** — `ChartDBG`×20087, `LiveDBG`×81, `출처축`×10, `CB③-P4`×10, `ScalerRefresh`×9, `SHS-EKS`×8, `Health`×5, `MainStallTrace`×3, `SessionStateDrop`×2, `SessionBackfill`×2, `Canary`×2, `PipePerf`×2, `CB⑤`×2, `System`×1, `LEVELS 09:30`×1

### `logs/20260917_SYSTEM.log` — 467.7KB · 3449행 · 최종 12:28:21

- 형식 평문 · 시각 인식 3431행 · INFO=3431, PLAIN=18
...
2026-09-17 05:39:30 [INFO] SYSTEM: [FeatureBuilder] 기동 시 전일(2026-09-16) 종가 버퍼 로드: 384봉
  …
2026-09-17 12:28:00 [INFO] SYSTEM: [CVD-ANCHOR] ts=12:27 vol=384 | live_buy=278 shadow_buy=225 anchor_buy=225 | resid(anchor)=0 resid(shadow)=0 unknown_ticks=0 resets=0
2026-09-17 12:28:00 [INFO] SYSTEM: [S6Detail] ensemble=2ms checklist_pre=22ms meta_gate=5ms gates=0ms imp=0ms shap=1ms corr=8ms dash_ui=0ms tail=16ms
2026-09-17 12:28:00 [INFO] SYSTEM: [PipePerf][DBG] total=699ms | S0=3ms S1=40ms S2=115ms S3=0ms S4=126ms S5=324ms S6=54ms S7=31ms S8=5ms
2026-09-17 12:28:04 [INFO] SYSTEM: [CybosRT-TICK] #67700 code=A056A raw_time=122804 parsed=12:28:04 price=1059.00 vol=1 bid1=1058.92 ask1=1059.00 flag=49 side=BUY anchor=1/0
2026-09-17 12:28:21 [INFO] SYSTEM: [CybosRT-TICK] #67800 code=A056A raw_time=122821 parsed=12:28:21 price=1058.84 vol=1 bid1=1058.80 ask1=1058.86 flag=49 side=BUY anchor=1/0
```
...
**컴포넌트 상위 15** — `CybosInvestorRaw`×826, `CybosRT-TICK`×713, `TickUI`×221, `CybosRT-ROLLOVER`×221, `BAR-CLOSE`×221, `CVD-ANCHOR`×221, `S6Detail`×209, `PipePerf`×209, `System`×113, `CybosSub`×63, `MicroRegime`×62, `RegimeFingerprint`×37, `IntradayRegime`×30, `OptionChain`×28, `SYSTEM`×26

### `logs/20260917_SIGNAL.log` — 350.9KB · 3119행 · 최종 12:28:00
...
### `logs/20260917_LEARNING.log` — 416.3KB · 3009행 · 최종 12:28:00
...
### `logs/20260917_MICRO.log` — 572.2KB · 1528행 · 최종 12:28:31

- 형식 평문 · 시각 인식 1528행 · DEBUG=1528
...
2026-09-17 08:45:09 [DEBUG] MICRO: [MICRO-TICK] #5 bid1=1057.32/1 ask1=1057.66/1 mp={'microprice_tick': 1057.49, 'midprice_tick': 1057.49, 'depth_bias_tick': 0.0} mlofi_tick=-2.7833 queue={'depletion_bid': -0.0, 'depletion_ask': 1.0, 'refill_bid': 0.0, 'refill_ask': 0.0, 'bid_cancel_add_ratio': -0.…
  …
2026-09-17 12:27:59 [DEBUG] MICRO: [MICRO-TICK] #121700 bid1=1058.78/2 ask1=1058.88/1 mp={'microprice_tick': 1058.8467, 'midprice_tick': 1058.83, 'depth_bias_tick': 0.2055} mlofi_tick=-4.3167 queue={'depletion_bid': -0.0, 'depletion_ask': -0.0, 'refill_bid': 0.0, 'refill_ask': 0.0, 'bid_cancel_add_…
2026-09-17 12:28:00 [DEBUG] MICRO: [MICRO-MINUTE] #211 ts=2026-09-17 12:27:00 close=1058.78 bias=-0.000975 slope=0.364342 depth_bias=-0.0158 mlofi_norm=0.077294 mlofi_pressure=1 mlofi_slope=55.373333 queue_signal=0.0517 queue_ma=0.0147 queue_momentum=0.0549 depletion=0.4986 refill=0.5014 imbalance_…
...
**컴포넌트 상위 15** — `MICRO-TICK`×1307, `MICRO-MINUTE`×221
...
### `data/heartbeat_MW0601_20260917.json` — 244B · 09-17 12:28:21
```json
{
 "pid": 20064,
 "written_at": "2026-09-17T12:28:21",
 "beat_epoch": 1789615700.7061753,
 "beat_age_sec": 0.4,
 "watching": true,
 "strikes": 0,
 "stall_sec": 180.0,
...
2. `logs/20260917_WARN.log`: ERROR 이상 2건
3. `logs/20260917_WARN.log`: **Traceback** 출현 3건 — 크래시/메모리 계열
4. `logs/20260917_SYSTEM.log`: 매분 루프 커버리지 209/371분 (56.3%) — 루프가 빠진 구간이 있다
5. `logs/20260917_SYSTEM.log`: 12:29~15:10 **연속 162분 매분 루프 기록 없음**
6. 메인 스레드 정지 5초 초과 **3건** (최대 12625ms) — CB⑤(파이프라인 경과시간)와 **단위가 다르다**. CB⑤ 미발동이 정상이며, 5초~180초 구간은 FZ-1 워치독도 보지 않는다. §5 잔차 표로 CB⑤ 사각 크기를 확인하라 (482차 F-3)
...
11. 미커밋 변경 68건 (실질 6건 · **코드(.py) 3건**) — 코드 변경이 커밋되지 않았다
